...
//! shipped to the field. Real dataset importers (OpenFDA, RxNorm, WHO) are
//! ROADMAP.md Phase 5 work still open; today this crate ships the compiler,
//! the validation pipeline, and a small bootstrap seed dataset.
